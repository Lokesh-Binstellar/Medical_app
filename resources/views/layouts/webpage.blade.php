        ...
        <div class="header-container">
            ...
            <nav>
                <ul class="nav-menu">
                    ...
                    <li><a href="{{ url('/webpage/privacy-policy') }}"><i class="fas fa-shield-alt"></i> Privacy
                            Policy</a></li>
                    <li><a href="{{ url('/webpage/terms') }}"><i class="fas fa-file-contract"></i> Terms &
                            Conditions</a></li>
                </ul>
    ...
    <footer class="footer">
        <div class="footer-content">
            <div class="footer-links">
                ...
                <a href="{{ url('/webpage/contact') }}">Contact</a>
                <a href="{{ url('/webpage/privacy-policy') }}}">Privacy</a>
                <a href="{{ url('/webpage/terms') }}">Terms</a>
            </div>
