...
@section('content')
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h4 class="card-title mb-0">Privacy Policy List</h4>
            <a href="{{ route('cms.privacy-policies.create') }}" class="btn addButton btn-primary">+ Add Privacy Policy</a>
        </div>
    ...
    <script>
        $(function() {
            var table = $('#aboutTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('cms.privacy-policies.index') }}", // Make sure your controller handles AJAX requests
                columns: [{
                        data: 'id',
                        name: 'id'
                    },
