...
@section('content')
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h4 class="card-title mb-0">Terms and Conditions  List</h4>
            <a href="{{ route('cms.terms-and-conditions.create') }}" class="btn addButton btn-primary">+ Add Terms and Conditions</a>
        </div>
    ...
    <script>
        $(function() {
            var table = $('#aboutTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('cms.terms-and-conditions.index') }}", // Make sure your controller handles AJAX requests
                columns: [{
                        data: 'id',
                        name: 'id'
                    },
