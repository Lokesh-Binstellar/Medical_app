                        ...
                        <form action="{{ route('homebanner.update', $banner->id) }}" method="POST"
                            ...
                            <div class="mb-3 error-msg">
                                ...
                                <input type="number" name="priority" id="priority" class="form-control"
                                    value="{{ old('priority', $banner->priority ?? 0) }}" min="0">
                            ...
                            <div class="mb-3">
                                ...
                                <div>
                                    <img src="{{ asset('banners/' . $banner->image) }}" alt="Current Banner"
                                        class="img-fluid" style="max-width: 100%; height: auto;">
                                </div>
                            </div>

                            <div class="modal-footer gap-2">
                                <button href="{{ route('homebanner.index') }}" class="btn btn-primary">Back to List</button>
