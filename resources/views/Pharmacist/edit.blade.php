{{-- <x-app-layout>
    ...
    <form class="max-w-sm mx-auto" action="{{ route('pharmacist.update', $pharmacies->id) }}" method="POST">
        @csrf
        @method('PUT')

        <div class="mb-5">
            <label for="name" class="block mb-2 text-sm font-medium text-gray-900">Name</label>
            <input type="text" name="name" id="name" value="{{ $pharmacies->name }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required />
        </div>

        <div class="mb-5">
            <label for="email" class="block mb-2 text-sm font-medium text-gray-900">Email</label>
            <input type="email" id="email" name="email" value="{{ $pharmacies->email }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required />
        </div>

        <div class="mb-5">
            <label for="address" class="block mb-2 text-sm font-medium text-gray-900">Address</label>
            <textarea name="address" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>{{ $pharmacies->address }}</textarea>
        </div>

        <div class="mb-5">
            <label for="phone" class="block mb-2 text-sm font-medium text-gray-900">Phone</label>
            <input type="tel" name="phone" id="phone" value="{{ $pharmacies->phone }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg p-2.5 w-full" required />
        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-lg-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" value="{{ $pharmacies->name }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="email" value="{{ $pharmacies->email }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="address" id="address" rows="5" required>{{ $pharmacies->address }}</textarea>
                                        </div>

                                        <!-- Phone -->
                                        <div class="form-group">
                                            <label for="phone">Phone</label>
                                            <input type="tel" name="phone" value="{{ $pharmacies->phone }}"
    ...
    <div class="container">
        <div class="page-inner">
            <form class="form-horizontal" action="{{ route('pharmacist.update', $pharmacies->id) }}" method="POST"
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Pharmacy Update Form</h4>
                    </div>
