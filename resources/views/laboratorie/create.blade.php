                                                ...
                                                <div class="row g-3 align-items-end mb-3 repeater-group">
                                                    ...
                                                    <div class="col-md-2">
                                                        ...
                                                        <input type="text" class="form-control" name="report[]"
                                                            min="0" placeholder="e.g. 15 hrs" required>
                                                    </div>
                                                    <div class="col-md-2">
                            ...
                            <div class="card accordion-item mt-3">
                                <h2 class="accordion-header" id="headingPackage">
                                    <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse"
                                        data-bs-target="#collapsePackage" aria-expanded="false"
                                        aria-controls="collapsePackage" style="background-color:#033a62;color:white;">
                                        Add Package Details
                                        <span class="ms-2 icon-toggle">
                                            <i class="fa-solid fa-chevron-down"></i>
                                        </span>
                                            ...
                                            <div class="col-md-12 mt-4" id="packageRepeater">
                                                <div class="row g-3 align-items-end mb-3 repeater-group">
                                                    <div class="col-md-2">
                                                        ...
                                                        <input type="text" class="form-control" name="package_name[0]"
                                                    ...
                                                    <div class="col-md-2">
                                                        ...
                                                        <input type="number" class="form-control"
                                                            name="package_visiting_price[0]" placeholder="e.g. 10 Rs"
                                                            required>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <label class="form-label fw-semibold">Home Price</label>
                                                    ...
                                                    <div class="col-md-2">
                                                        <label class="form-label fw-semibold">Report Time</label>
                                                        <input type="text" class="form-control"
                                                            name="package_report[0]" placeholder="e.g. 15 hrs" required>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <label class="form-label fw-semibold">Offer Visiting
                                                            Price</label>
                                                        <input type="text" class="form-control"
                                                            name="package_offer_visiting_price[0]" placeholder="e.g. 5 Rs"
                                                            required>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <label class="form-label fw-semibold">Offer Home
                                                            Price</label>
                                                        <input type="text" class="form-control"
                                                            name="package_offer_home_price[0]" placeholder="e.g. 10 Rs"
                                                            required>
                                                    </div>
