...
<div class="container">
  <div class="col-12">
    <div class="card">
      ...
      <div class="card-body">
        <form class="row g-3" id="deliveryPersonCreateForm" action="{{ route('delivery_person.store') }}" method="POST" enctype="multipart/form-data">
          @csrf

          {{-- Delivery Person Name (mapped to delivery_person_name) --}}
          <div class="col-md-6">
            <div class="form-floating form-floating-outline">
              <input type="text" name="delivery_person_name" id="delivery_person_name" class="form-control" placeholder="Full Name" value="{{ old('delivery_person_name') }}" />
          ...
          <div class="col-md-6">
            <div class="form-floating form-floating-outline">
              <input type="tel" name="phone" id="phone" class="form-control" placeholder="Phone" pattern="^\d{7,12}$" oninput="this.value=this.value.replace(/[^0-9]/g,'').slice(0,12)" value="{{ old('phone') }}" />
          ...
          <div class="col-md-6">
            <div class="form-floating form-floating-outline">
              <input type="text" name="pincode" id="pincode" class="form-control" placeholder="Pincode" value="{{ old('pincode') }}" />
...
{{-- Address --}}
          ...
          <div class="card-action mt-3">
            ...
            <button type="button" class="btn btn-secondary" onclick="window.location='{{ route('delivery_person.index') }}'">Cancel</button>
          </div>
