...
document.addEventListener('DOMContentLoaded', function () {
    (function () {
        const pharmacyCreateForm = document.getElementById('pharmacyCreateForm');

        // Initialize FormValidation
        const fv = FormValidation.formValidation(pharmacyCreateForm, {
            fields: {
                pharmacy_name: {
                    validators: {
                        notEmpty: {
                ...
                license: {
                    validators: {
                        ...
                        regexp: {
                            regexp: /^[A-Za-z0-9\/-]+$/,
                            message: 'Only letters, numbers, hyphens, slashes allowed'
                        }
                    }
                },
